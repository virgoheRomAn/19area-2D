...
export const getDoorJSX = function (door, doorindex) {
  // switch (door.configModelTypeGid) {
  //   case '135':
  //     //飘窗
  //     return this.renderDoor135(door);
  //   default:
  //     switch (door.modelBaseType) {
  //       case '1':
  //         //通用门
  //         return this.renderDoor1(door);
  //       case '2':
  //         //通用窗
  //         return this.renderDoor2(door);
  //       default:
  //         return this.renderDoor1(door);
  //     }
  // }
  let menuShow = (e, index) => {
    door.menuL = e.pageX;
    door.menuT = e.pageY;
    door.showmenu = true;
    this.setState({});
  ...
  let handleTOBchange = ()=>{
    door.ud = door.ud == 0 ? 1 : 0;
    this.setState({});
  }
  let handleLORchange = ()=>{
    door.lr = door.lr == 0 ? 1 : 0;
    this.setState({});
  }
  ...
  let wall = door.wall;
  // debugger
  // door.configModelTypeGid = 138;
  // door.modelBaseType = 1;  //1是门 2 是窗
...
export default function (doorsn) {
  ...
  return (
    doorsn.map((door, doorindex) => {
      return this.getDoorJSX(door,doorindex);
    })
  );
}